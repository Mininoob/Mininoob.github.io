...
- Open decisions (do not invent): public links for Polymage, Pinq, and OriginalCopy; whether to publish the resume PDF (source file contains a phone number — needs explicit OK before going public).
...
- Second resume provided 2026-07 (~/Downloads/Uploaded resume (2).pdf, also contains phone number): adds Java/MATLAB/Sleuth Kit/Autopsy, B.S. + 3.5 GPA, IEEE venue, AR plume/fire simulation detail, FIRST Tech Challenge mentorship facts ($10K equipment, five-student team, regional qualification). CACI intern start date differs between resumes (03/2022 vs 09/2022) — site says "2022–2024" to stay safe.
